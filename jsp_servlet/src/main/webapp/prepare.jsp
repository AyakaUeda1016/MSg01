...
<body>
    <div class="container">
        ...
        <div class="blackboard">
            ...
            <div class="action-buttons">
                <a href="simulation.html"><button class="btn btn-light-orange" id="readyBtn">準備完了</button></a>
            </div>
        </div>

        <a href="scenario.html"><button class="btn btn-wood" id="backBtn">戻る</button></a>
    </div>
