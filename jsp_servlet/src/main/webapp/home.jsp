        ...
        <div class="note-area">
            ...
            <div class="buttons-container">
                ...
                <div class="button-wrapper">
                    <a href="./HomeServlet?sb=senario" class="menu-button simulation" data-description="学習シミュレーションを行います">
                ...
                <div class="button-wrapper">
                    <a href="./HomeServlet?sb=growth_record" class="menu-button growth" data-page="growth-record.html"
                ...
                <div class="button-wrapper">
                    <a href="./HomeServlet?sb=setting" class="menu-button settings" data-page="settings.html"
